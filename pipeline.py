...
blend_path = "apartment.usdc"
# Initialize the renderer with the blend file and camera
renderer = BlenderRenderer(blend_filepath=blend_path, camera_name="Camera_001")
...
accumulated_poses = []
accumulated_poses.append(
    bot.current_pose[:3, 3].copy()
)  # Store current pose after update
...
for i, move in enumerate(movements):
    ...
    cv2.imshow("Current frame", frame_curr)
    cv2.waitKey(20)
